    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <div id="tab-wrapper" class="col-lg-4 col-sm-6 col-md-6 col-xs-12 col-lg-offset-1 col-sm-offset-2 col-md-offset-1 card">
                <div class="info">
                    <div id="title-name" class="title">Sie wurden erfolgreich registriert.</div>
                    <div id="desc-firmname" class="desc">Es wurde eine Mail an Ihre angegebene E-Mail-Adresse versendet.<br/><small style="text-decoration: underline;">Zu Demozwecken wurde eine Alternative entwickelt. Bitte klicken Sie hierfür den Button.</small></div>
                </div>
<!-- Modal -->
